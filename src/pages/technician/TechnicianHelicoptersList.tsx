...
interface TechnicianHelicoptersListProps {
  darkMode: boolean
}

const TechnicianHelicoptersList = ({ darkMode = false }: TechnicianHelicoptersListProps) => {
  ...
  const handleUpdateHelicopter = async (updatedHelicopter: Helicopter) => {
    try {
      console.log("TechnicianHelicoptersList - handleUpdateHelicopter llamado con:", updatedHelicopter)
  ...
  return (
    <div className="space-y-6 pt-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        <h1 className="text-2xl font-semibold">Helicópteros - Vista Técnico</h1>
...
export default TechnicianHelicoptersList
