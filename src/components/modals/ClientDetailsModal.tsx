...
const ClientDetailsModal = ({ isOpen, onClose, clientId, darkMode = false }: ClientDetailsModalProps) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Detalles del Cliente" maxWidth="max-w-4xl" darkMode={darkMode}>
      <div className="space-y-6">
        ...
        {/* Filtro de vuelos */}
        <div>
          <h4 className={`text-base font-medium mb-3 ${darkMode ? "text-white" : "text-gray-900"}`}>Filtrar Vuelos</h4>
