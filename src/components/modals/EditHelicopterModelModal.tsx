...
// Actualizar las importaciones para usar los tipos centralizados
import type { HelicopterModel, EditHelicopterModalProps, EditHelicopterFormData } from "../../types/api"
